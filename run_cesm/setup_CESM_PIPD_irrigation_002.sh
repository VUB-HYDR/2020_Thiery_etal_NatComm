...
# bash script to set up a CESM1.2.2 transient historical run with year-2000 land-use and including irrigation
...
# include irrigation !!!
# http://www.cesm.ucar.edu/models/cesm1.2/clm/models/lnd/clm/doc/UsersGuide/x12511.html
# Append "-irrig" to CLM_BLDNML_OPTS in env_run.xml (you could also use an editor)
./xmlchange CLM_BLDNML_OPTS="-irrig .true." -append
