...
! _WT addition 26/02/2016
   real(r8), pointer :: rah1(:)            ! thermal resistance (s/m)
   real(r8), pointer :: taf1(:)            ! air temperature within canopy space [K]
! _WT addition 26/02/2016
...
! _WT addition 26/02/2016   (this is the thermal resistance towards the air, not towards the ground) 
         rah1(p) = rah(p,1)
! _WT addition 26/02/2016   
...
! _WT addition 26/02/2016   (assign local variable taf to pointer taf1 in order to save it as an output) 
         taf1(p) = taf(p)
! _WT addition 26/02/2016   
