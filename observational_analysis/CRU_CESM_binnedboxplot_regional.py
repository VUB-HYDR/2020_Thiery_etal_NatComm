...
#Save results  
if figsave == True:
  figpath = '/net/exo/landclim/wthiery/observational_analysis/Figures/CRU_CESM_comp/dT_tot_irrTESTT.%s.%s.all.%i-%i.%i-%i.%s'%(SREX_region,response,yr_start1,yr_end1,yr_start2,yr_end2,figformat)
